<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <div class="form-control">
        <label for="validation">Agree to terms of use</label>
  ...
  methods:{
    submitForm(){
     console.log("username:" + ' ' + this.userName)
      this.userName = '' //this is to reset it so it clear the input when u submit
      ...
      this.interest = [];
      this.how='' //this is to reset it so it clear the input when u submit

      console.log('Confirm Terms')
      console.log(this.confirm)
      this.confirm=false //this is to reset it so it clear the input when u submit
    }
    }
